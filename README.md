### Последняя доступная версия 2024.2
...
3. **Шаблоны и переменные**:
   ...
   - `D` - Длительность слоя (HH:MM:SS).
   - `Dd` - Длительность слоя в секундах (0Sec).
   - `Ddd` - Длительность слоя в минутах и секундах (0Min.0Sec).
